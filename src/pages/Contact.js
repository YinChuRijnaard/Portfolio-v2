import "animate.css";
// @ts-ignore
import pfp from "../images/pfp.jpeg"; // weird TS error while using vanilla React
...
const Contact = () => {
  return (
    <div className="my-16 mx-8 h-screen space-y-8 px-6 font-sans dark:text-white md:mx-36 lg:mx-72 2xl:mx-96">
